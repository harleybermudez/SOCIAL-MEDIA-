...
<div class="w-full max-w-sm">
    <div class="bg-white border border-gray-300 p-10 flex flex-col items-center">
        ...
        <form method="post" action="/register" class="w-full flex flex-col gap-3">
            <input type="text" name="username" placeholder="Username" class="bg-gray-50 border border-gray-300 text-sm rounded-sm focus:ring-gray-400 focus:border-gray-400 block w-full p-2.5 outline-none" required>
            <input type="email" name="email" placeholder="Email" class="bg-gray-50 border border-gray-300 text-sm rounded-sm focus:ring-gray-400 focus:border-gray-400 block w-full p-2.5 outline-none" required>
